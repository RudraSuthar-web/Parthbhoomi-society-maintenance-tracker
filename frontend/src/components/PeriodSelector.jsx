    ...
    <div className="rounded-xl border border-slate-200 bg-slate-50 overflow-hidden">
      <div className="flex items-center justify-between px-3 pt-2 pb-2">
        <div className="flex items-center">
          <label className="block text-[15px] font-bold text-on-surface-variant uppercase tracking-widest">
            Year
          </label>
          <div className="relative">
            <select
              ...
              className="bg-transparent text-[15px] font-bold text-primary outline-none cursor-pointer appearance-none pr-8 block text-on-surface-variant tracking-widest px-1"
            >
